  ...
  return (
      <div>
          ...
          <div className="text-center py-12 max-w-5xl mx-auto">
              ...
              <p className="text-xl mb-6 mx-24">Our gemstone recognition app allows you to quickly and accurately identify precious minerals. Whether you're a collector, jeweler, or geology enthusiast, our technology will help you uncover the beauty hidden in every stone.</p>
              <ul className="list-disc list-inside text-left max-w-sm mx-auto mb-10">
                  ...
                  <li className='pb-2 text-lg'><strong>Extensive Database</strong>: Access detailed information on hundreds of different images.</li>
